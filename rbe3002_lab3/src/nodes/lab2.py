...
class Lab2:
    ...
    def __init__(self):
        ...
        #from original lab2 file
        # CHANGE FROM .go_to TO .arc_to HERE
        #rospy.Subscriber('/move_base_simple/goal', PoseStamped, self.go_to) 
        
        # this node subscribes to PoseStamped messages on lab3/path_points topic
        # calls self.go_to or arc_to based on path
        self.lab2_sub = rospy.Subscriber('/path', Path, self.drive_robot)
        self.frontier_sub = rospy.Subscriber('/viz_msg', GridCells, self.drive_robot)
        # done alert publisher (should be helpful)
        self.done = rospy.Publisher('/lab2/done_alert', Bool, queue_size = 10) # still dont know how queue_size actually works. might be 2 in this case because its a boolean
